...
const SVC_URL = "https://appadaycreator.com/ai-prompt-designer/";
const SVC_NAME = "AIプロンプト設計ツール";

test.describe("AIプロンプト設計ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("ai-prompt-designer");
